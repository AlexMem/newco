...
public class TripsControllerTest extends BaseTest {
    ...
    @Test
    public void whenPostTripThenCreateTrip() throws Exception {
    ...
    @Test
    public void givenTripsWhenGetTripsThenReturnJsonArray() throws Exception {
    ...
    @Test
    public void givenTripsWhenGetTripsByIdThenReturnJsonArray() throws Exception {
    ...
    @Test
    public void givenTripsWhenDeleteTripsByIdThenDeleteTrip() throws Exception {
    ...
    @Test
    public void givenTripsWhenUpdateTripsThenUpdateTrip() throws Exception {
